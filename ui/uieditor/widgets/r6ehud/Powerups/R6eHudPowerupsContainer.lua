...
CoD.PowerUps.ClientFieldNames = {
	...
	{
		clientFieldName = "guard",
		material = RegisterMaterial( "ui_icon_hud_guard_power_up" )
	},
	{	
		clientFieldName = "infinite_grenade",
		material = RegisterMaterial( "ui_icon_hud_guard_power_up" )
	},
	{	
		clientFieldName = "bonfire_sale",
		material = RegisterMaterial( "ui_icon_hud_zb_bondiresale" )
	}
}
